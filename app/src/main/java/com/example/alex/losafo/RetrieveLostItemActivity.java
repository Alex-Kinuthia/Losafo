...
public class RetrieveLostItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retrieve_lost_item);
        ...
        FAB.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent i = new Intent(RetrieveLostItemActivity.this, RegisterLostItemActivity.class);
                startActivity(i);
