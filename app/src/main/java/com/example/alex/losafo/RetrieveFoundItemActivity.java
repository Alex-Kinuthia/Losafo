...
public class RetrieveFoundItemActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retrieve_found_item);
        ...
        FAB.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent i = new Intent(RetrieveFoundItemActivity.this, ReportFounditemActivity.class);
                startActivity(i);
